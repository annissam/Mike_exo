...
if(anps_header_media(get_the_ID(), "anps-blog-grid")!="") {
    ...
    $post_data .= "<a href='".get_permalink()."' title='".get_the_title()."'><h2><i class='fa fa-thumb-tack hovercolor'></i>&nbsp;".get_the_title()."</h2></a>";
     }
    else {
        $post_data .= "<a href='".get_permalink()."' title='".get_the_title()."'><h2>".get_the_title()."</h2></a>";
    }
	//$post_data .= "<a href='".get_permalink()."'><h2>".get_the_title()."</h2></a>";
