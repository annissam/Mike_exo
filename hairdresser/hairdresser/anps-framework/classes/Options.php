...
class Options extends AnpsFramework {
    ...
    public function save_page_setup() {
        ...
        update_option('anps_portfolio_slug',$_POST['anps_portfolio_slug']);
        ...
        update_option('anps_products_columns',$_POST['anps_products_columns']);
        update_option('anps_products_per_page',$_POST['anps_products_per_page']);  
        update_option('anps_above_nav_bar',$_POST['anps_above_nav_bar']);
        update_option('anps_vc_legacy',$_POST['anps_vc_legacy']);
        update_option('anps_post_meta_comments',$_POST['anps_post_meta_comments']);
        update_option('anps_post_meta_categories',$_POST['anps_post_meta_categories']);
        update_option('anps_post_meta_author',$_POST['anps_post_meta_author']);
        update_option('anps_post_meta_date',$_POST['anps_post_meta_date']);
    ...
    public function save_media() {
        ...
        update_option('anps_text_logo',$_POST['anps_text_logo']);
