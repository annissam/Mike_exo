angular.module('OnlyBaddiesApp.auth.controllers', [])


.controller('WelcomeCtrl', function($scope, $state, $ionicModal){
	$scope.bgs = ["img/accueil.jpg"];
...
.controller('CreateAccountCtrl', function($scope, $state, $http){
	...
	$scope.doSignUp = function(){
		$http({
			url:"http://localhost/siteapp/api/register.php",
			methode:"POST",
			data:{
				"name": $scope.user.name,
				"useName": $scope.user.userName,
				"email": $scope.user.email,
				"passeword": $scope.user.passeword,
