            ...
            <div class="post-content nobuttontopmargin">
				...
				?>
										<p><a href="<?php echo esc_url($next_attachment_url); ?>" title="<?php echo esc_attr( get_the_title() ); ?>" rel="attachment"><?php
											$attachment_size = apply_filters( 'anps_attachment_size', 900 );
                ...
                <div class="post-meta text-center">
                    <ul>               
                        <li><i class='hovercolor fa fa-comment-o'></i><a href='<?php echo get_permalink() . "#comments"; ?>'><?php echo get_comments_number()." ".esc_html__("comments", 'hairdresser'); ?></a></li>
                        <li><i class='hovercolor fa fa-user'></i><span><?php echo esc_html__("posted by", 'hairdresser')." <a href='".get_author_posts_url(get_the_author_meta('ID'))."' class='author'>".get_the_author()."</a>"; ?></span></li>
                ...
                <footer>
                    ...
                    <?php
                        ...
                        foreach ($posttags as $tag) {
                            ...
                            echo '<a href="' . esc_url(home_url('/')) . 'tag/' . esc_url($tag->slug) . '/">';
