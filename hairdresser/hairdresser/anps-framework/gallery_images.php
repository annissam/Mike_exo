...
class Gallery_images {
    ...
    function gallery_images_box() {
                                    ...
                                    if ( $attachments )
                                            foreach ( $attachments as $attachment_id ) {
                                                    echo '<li class="image" data-attachment_id="' . esc_attr($attachment_id) . '">
                                                            ...
                                                            <ul class="actions">
                                                                    <li><a href="#" class="delete" title="' . esc_html__( 'Delete image', 'hairdresser' ) . '">' . esc_html__( 'Delete', 'hairdresser' ) . '</a></li>
                                                            </ul>
                                                    </li>';
                                            }
                            ?>
            ...
            <p class="add_product_images hide-if-no-js">
                    <a href="#"><?php esc_html_e( 'Add gallery images', 'hairdresser' ); ?></a>
            </p>
                    ...
                    jQuery(document).ready(function($){
                            ...
                            jQuery('.add_product_images').on( 'click', 'a', function( event ) {
                                    ...
                                    product_gallery_frame = wp.media.frames.downloadable_file = wp.media({
                                            ...
                                            title: '<?php esc_html_e( 'Add Images to Gallery', 'hairdresser' ); ?>',
                                            button: {
                                                    text: '<?php esc_html_e( 'Add to gallery', 'hairdresser' ); ?>',
                                            },
                                            multiple: true
                                    });
                                                    ...
                                                    if ( attachment.id ) {
                                                            ...
                                                            $product_images.append('\
                                                                    <li class="image" data-attachment_id="' + attachment.id + '"">\
                                                                            ...
                                                                            <ul class="actions">\
                                                                                    <li><a href="#" class="delete" title="<?php esc_html_e( 'Delete image', 'hairdresser' ); ?>"><?php esc_html_e( 'Delete', 'hairdresser' ); ?></a></li>\
                                                                            </ul>\
                                                                    </li>');
                                                    }
    ...
    function image_meta() {
        ...
        foreach($page as $item) {
            add_meta_box( 'gallery_images', esc_html__( 'Gallery images', 'hairdresser' ), array(&$this,'gallery_images_box'), $item,'side');
        }
    }
