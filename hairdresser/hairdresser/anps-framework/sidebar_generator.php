		...
		?>
			<script>
				function add_sidebar( sidebar_name )
				{
                    ...
                    mysack.setVar( 'security', jQuery('#_wpnonce').val() );
		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				<div class="sbg_container">
					...
					<p>
						<?php _e( 'Select the sidebar you wish to display. If no value is selected, then the global sidebar will be used. Any other value will overwrite the global option. Use "None" to remove the global sidebar for on a specific post/page.', 'hairdresser' ); ?>
					</p>
					<ul>
					<?php
						global $wp_registered_sidebars;
						for($i=0;$i<1;$i++) { ?>
							<li><?php _e("Left", 'hairdresser'); ?>:
							<select name="sidebar_generator">
								<option value="0"></option>
								<option value="-1"<?php if($selected_sidebar[$i] == '-1'){ echo " selected";} ?>><?php _e("None", 'hairdresser'); ?></option>
							<?php
							...
							<?php _e("Right", 'hairdresser'); ?>:
							<select name="sidebar_generator_replacement">
								<option value="0"></option>
								<option value="-1"<?php if($selected_sidebar_replacement[$i] == '-1'){ echo " selected";} ?>><?php _e("None", 'hairdresser'); ?></option>
							<?php
