...
<div class="row">
<form class="shipping_calculator col-md-9" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

	<h2><a href="#" class="shipping-calculator-button"><?php esc_html_e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn btn-md pull-right"><?php esc_html_e( 'Update Totals', 'woocommerce' ); ?></button></p>
