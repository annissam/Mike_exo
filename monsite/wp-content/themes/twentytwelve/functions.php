...
'name'	=>	'zone logo',
'id' 	=> 'zone_logo',
'description'	=> 'region qui apparait dans le header et qui servira principalement à placer un logo',
'before_widget'	=>'<aside id="%s" class="widget %2s">',
'after_widget'	=>'<aside id="%s" class="widget %2s">',
'before_title'	=> '<h3 class="widget-title">',
'after_widget'	=> '</h3>'
));
